...
class Foreigner::SchemaDumperTest < Foreigner::UnitTest
  ...
  test 'dump_foreign_key' do
    ...
    assert_dump "add_foreign_key \"foos\", \"bars\", :name => \"lulz\", :dependent => :delete, :on_update => :cascade", Foreigner::ConnectionAdapters::ForeignKeyDefinition.new('foos', 'bars', column: 'bar_id', primary_key: 'id', name: 'lulz', dependent: :delete, on_update: :cascade)
  end
